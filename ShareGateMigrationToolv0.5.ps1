...
function CheckCSVDataFile () {
    ...
    $Global:CSVDataFile = Get-ChildItem ".\$BatchesFolder\$BatchName\$Report\$CSVDataFile" | Sort-Object -Descending -Property LastAccessTime | Select-Object -First 1 | Select-Object -ExpandProperty Name
